...
const PROJECTS = [
  ...
  { id: "av-explain", label: "AV Explainability", icon: "globe",
    url: "https://harsh010102.github.io/portfolio/av-explainability/",
    desc: "TUM × Continental AG: a multimodal pipeline explaining autonomous-vehicle driving decisions in natural language." },
  { id: "satellite", label: "Satellite Pipeline", icon: "globe",
    url: "https://harsh010102.github.io/portfolio/satellite-data-pipeline/",
    desc: "MPI-SWS: Sentinel-2 ingestion and land-cover classification at 95% accuracy." },
  { id: "groundwater", label: "Groundwater Forecasting", icon: "globe",
    url: "https://harsh010102.github.io/portfolio/upei-mitacs/",
    desc: "UPEI × MITACS: Prophet, BiLSTM and GRU forecasting for three PEI watersheds — first-author, used in provincial climate-adaptation policy." },
];
